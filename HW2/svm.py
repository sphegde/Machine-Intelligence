...
class Svm (object):
    ...
    def __init__ (self, inputDim, outputDim):
        ...
        self.W = np.random.normal(0,0.01,(inputDim,outputDim)) # 3073x10
        #########################################################################
        #                       END OF YOUR CODE                                #
        #########################################################################
    ...
    def calLoss (self, x, y, reg):
        ...
        """
        loss = 0.0
        dW = np.zeros_like(self.W)  # size : 3073x10
        #############################################################################
        # TODO: 20 points                                                           #
    ...
    def predict (self, x):
        ...
        yPred = np.argmax(np.dot(self.W, x), axis=0) #returns the index of the highest scores through trained weights
